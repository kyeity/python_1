...
if __name__ == '__main__':
    firstbook = Book('comedy', 'Lol', 'Author_of_comedy')
    secondbook = Book('drama', 'cry', 'Author_of_drama')
    thirdbook = Book('science', 'NASA', 'Author_of_science')
    ...
    Library.takeBook(firstbook)


    bkk = [firstlistofbooks, secondlistofbooks,thirdlistofbooks]
    print(bkk)

#show = Library.takeBook('comedy', 'Lol', 'Author_of_comedy')

    #lb = Library('Street 1', '+38971723', firstlistofbooks, firstreader)

print('-------------------')


#print(lb.returnBook(firstlistofbooks))
